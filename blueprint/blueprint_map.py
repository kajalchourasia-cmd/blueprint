...
def render_blueprint_map() -> None:
    st.set_page_config(page_title="Full Blueprint", page_icon="⌖", layout="wide", initial_sidebar_state="collapsed")
    st.markdown(
