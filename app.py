...
def questions_dialog():
    if st.session_state.get("generating_blueprint"):
        ...
        st.markdown('<div class="generation"><div class="generation-orbit"></div><h3>Building your Blueprint</h3><p>Matching your context to phases, costs, assumptions, and the first evidence-producing action.</p><div class="generation-lines"><i></i><i></i><i></i></div></div>', unsafe_allow_html=True)
        profile = _create_profile(answers)
        st.session_state["profile"] = profile
        st.session_state.setdefault("projects", {})[profile.idea or "Untitled project"] = {"profile": profile}
